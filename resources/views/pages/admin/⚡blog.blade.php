    ...
    <div class="grid grid-cols-12 items-center my-10">
        <div class="col-span-6">
            <div class="flex flex-row gap-2">
                <i class="text-xl text-[#4C7BC3] fa-solid fa-paper-plane content-center py-2 px-3 bg-white shadow-lg rounded-lg"></i>
                <div class="flex flex-col">
                    <p class="text-xl font-extrabold content-center">Berita</p>
                    <p class="text-sm font-extrabold text-gray-400 content-center">Control Berita</p>
                </div>
            </div>
        </div>
        <div class="col-span-6">
            <div class="flex flex-row gap-2">
                ...
                <livewire-button.button-variant-2-responsive class="me-auto" type="#" judul="Tambah Berita" warna="bg-[#4C7BC3]" icon="fa-solid fa-plus"/>
            </div>
        </div>
    </div>
    <div class="grid grid-cols-12 items-center my-10">
